...
%\epsfig{file=\Figdir electron_number_density2.eps,width=212.00pt,height=300.00pt}
\special{psfile=\Figdir electron_number_density2.eps hscale=100.00 vscale=100.00}
\end{picture}}
\end{center}
\caption{\label{#2}#1}
\end{figure}}
