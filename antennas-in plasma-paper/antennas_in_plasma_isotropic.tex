...
\documentclass[two-column,ras]{agutex}
...
\titlerunninghead{SPACECRAFT ANTENNAS IN ISOTROPIC PLASMA}

% Author mailing address: please repeat this command for
% each author and alphabetize authors:

\authoraddr{T. H. Oswald,
Department of Extraterrestrial Physics, Institute of Space Research, Austrian Academy of Sciences, Schmiedlstrasse 6, Graz, AT8042, Austria.
...
\altaffiltext{1}{Department of Extraterrestrial Physics, Institute of Space Research, Austrian Academy of Sciences, Schmiedlstrasse 6, Graz, AT8042, Austria.}
...
\begin{figure*}
\noindent\includegraphics[width=39pc]{stereo.eps}
...
\bibitem[{\textit{Weiglhofer}(1986)}]{weiglhofer}
